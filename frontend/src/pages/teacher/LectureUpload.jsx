  ...
  return (
    <div className="min-h-screen bg-gray-900 p-6 max-w-4xl mx-auto font-sans text-gray-100">
      ...
      >
        ...
        <div>
          <p htmlFor="title" className="block mb-1 font-semibold">
            Lecture Title
          </p>
          <input
            id="title"
        ...
        <div>
          <p htmlFor="description" className="block mb-1 font-semibold">
        ...
        <div>
          <p className="block mb-1 font-semibold">File Type</p>
          <select
            value={fileType}
        ...
        <div>
          <p className="block mb-1 font-semibold">Difficulty Level</p>
          <select
            value={difficulty}
        ...
        <div>
          <p htmlFor="file" className="block mb-1 font-semibold">
            Select File
          </p>
          <input
            id="file"
